...
<p style="text-align:center;"> <img class="center" height="80" src="{{ "../htop_1.png" | absolute_url }}" alt="" /> </p>
...
<p style="text-align:center;"> <img class="center" height="80" src="{{ "../htop_2.png" | absolute_url }}" alt="" /> </p>
...
<p style="text-align:center;"> <img class="center" height="80" src="{{ "../htop_4.png" | absolute_url }}" alt="" /> </p>
