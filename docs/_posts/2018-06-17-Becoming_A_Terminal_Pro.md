...
<p style="text-align:center;"> <img class="center" width="300" src="{{ "../htop_1.png" | absolute_url }}" alt="" /> </p>
...
<p style="text-align:center;"> <img class="center" width="300" src="{{ "../htop_4.png" | absolute_url }}" alt="" /> </p>
...
<p style="text-align:center;"> <img class="center" width="300" src="{{ "../htop_3.png" | absolute_url }}" alt="" /> </p>
